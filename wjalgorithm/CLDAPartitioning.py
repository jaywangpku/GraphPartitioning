...
def CLDAAL(edgelist, numOfParts):
    f = open(edgelist, "r")
    ...
    for line in f:
        ...
        # 要花大量时间
        AllDegrees = 0.0
        for i in ver2degreeDic:
            AllDegrees = AllDegrees + ver2degreeDic[i]
        AvgDegrees = AllDegrees / edgeNum

        edgeDegree = partialDegSrc + partialDegTar
...
# CLDAAL("/home/w/data/Wiki-Vote.txt", 100)
